...
public class AvifDecoder {
  ...
  /**
   * Returns the native decoder handle used by {@link AvifHardwareDecoder} on API 29+.
   *
   * <p>Do not call {@link #release()} until all hardware-buffer decodes using this handle have
   * finished.
   */
